        ...
        <div className="w-full">
            ...
            <section className="bg-white text-slate-800 py-20 px-6 border-b border-slate-200">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl max-w-2xl mx-auto text-slate-600">We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-800 focus:border-transparent outline-none transition"
                                        placeholder="Jee Ma"
                                    />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        required
                                        rows="5"
                                        className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-800 focus:border-transparent outline-none transition resize-none"
                                        placeholder="Tell us more about your inquiry..."
                                    ></textarea>
                                </div>
                                <button
                                    type="submit"
                                    className="w-full bg-slate-800 text-white py-3 rounded-lg font-semibold hover:bg-slate-700 transition flex items-center justify-center gap-2"
                                >
                                    <Send size={18} />
                                    Send Message
                                </button>
                                {submitted && (
                                        <div className="bg-slate-100 text-slate-800 p-4 rounded-lg text-center">
                        ...
                        {/* Map or Additional Info */}
                            <div className="bg-slate-50 rounded-lg p-8 shadow-md border border-slate-200">
            ...
            <section className="bg-white py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="max-w-3xl mx-auto space-y-4">
                        <details className="bg-slate-50 rounded-lg p-6 cursor-pointer hover:bg-slate-100 transition border border-slate-200">
